...
export default function HomeView(): ReactElement<HTMLDivElement> {
    return <div className="homeView">
        <div className="homeContainer">
            <h1 className="text-titleH1-blackBasic-uppercase">{TextContent.H1_TITLE}</h1>
            <nav className="navHome">
                <Link to={PagePath.SANDBOX} className="text-body-blackShade2-lowercase link">
                    {TextContent.BUTTON_GO_TO_SANDBOX}
                </Link>
                <Link to={PagePath.LIBRARY} className="text-body-blackShade2-lowercase link">
